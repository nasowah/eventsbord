...
class RegistrantsControllerTest < ActionController::TestCase
  ...
  test "should create registrant" do
    assert_difference('Registrant.count') do
      post :create, registrant: { email: @registrant.email, first_name: @registrant.first_name, last_name: @registrant.last_name, mobile: @registrant.mobile, ticket: @registrant.ticket }
    end
  ...
  test "should update registrant" do
    patch :update, id: @registrant, registrant: { email: @registrant.email, first_name: @registrant.first_name, last_name: @registrant.last_name, mobile: @registrant.mobile, ticket: @registrant.ticket }
    assert_redirected_to registrant_path(assigns(:registrant))
  end
